...
\begin{itemize}
    ...
    \item $\displaystyle F(x) = \sum_k \sum_n {n\choose k}x^n = \sum_{k\ge 0} {x^k\over (1-x)^{k+1}}={1\over 1-x}\cdot {1\over 1-{x\over 1-x}}={1\over 1-2x}$
\end{itemize}

\item
Example 1 [Wilf 121]
\begin{itemize}
    \item let's evaluate $f(n) = \sum_{k\ge 0} {k\choose n-k}$; after Step 2, $F(x) = \sum_n x^n \sum_{k\ge 0} {k\choose n-k}$
